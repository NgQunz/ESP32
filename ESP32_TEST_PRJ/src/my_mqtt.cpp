...
char Buffer[1000];
int Led1 = 1, Led2 = 1, Led3 = 1, Fan2 = 1, Fan1 = 1;
...
void Data_to_Json(int js_temp, int js_gas_limit, int js_led1, int js_led2, int js_led3, int js_fan1, int js_fan2)
{
  int Length_Buffer;
  String ESP32_Data = "{\"temp\":\"" + String(js_temp) + "\"," + "\"gas_limit\":\"" + String(js_gas_limit) + "\"," +
